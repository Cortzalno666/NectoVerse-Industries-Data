-- Self HBE 2.0, Transparent, non-blalant
...
local function createAndStabilizePart(part, size, name, transparency)
    ...
    clone.Transparency = 1 -- invisible
...
local function expandParts()
    ...
    if character then
        ...
        if humanoidRootPart then
            local hrpClone1 = createAndStabilizePart(humanoidRootPart, Vector3.new(12, 12, 12), "HumanoidRootPart_Expanded1", 1)
