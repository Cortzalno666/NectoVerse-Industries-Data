...
screenGui.Name = "MinimalAimbotGui"
screenGui.ResetOnSpawn = false

-- Place in CoreGui if possible, fallback to PlayerGui
...
-- Single Draggable Toggle Button
local toggleBtn = Instance.new("TextButton")
toggleBtn.Size = UDim2.new(0, 50, 0, 50)
toggleBtn.Position = UDim2.new(0, 15, 0.5, -25) -- Left side center
toggleBtn.BackgroundColor3 = Color3.fromRGB(200, 50, 50) -- Red for OFF
...
-- Optional stroke for a cleaner look against bright backgrounds
    ...
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        input.Changed:Connect(function()
            if input.UserInputState == Enum.UserInputState.End then
                ...
                -- If we didn't drag it, treat it as a click/toggle
                if not isMoved then
...
toggleBtn.InputChanged:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
        if dragging then
            ...
            -- If moved more than 5 pixels, consider it a drag instead of a tap
