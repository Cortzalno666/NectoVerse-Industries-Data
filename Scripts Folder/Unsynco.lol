...
local function toggleStealthPhantom()
    ...
    if ghostActive then
        ...
        -- FIXED: Removed the lines that set CanTouch/CanQuery to false.
        -- This ensures the ball and game world still register your character.

        -- Maintain Speed Protection
